	...
	*/
	join : async function() {
		try {
			...
			const sql = `INSERT INTO member (memId, memPw, pwHint, memNm, email, cellPhone, snsType, snsId, address)
									VALUES (:memId, :memPw, :pwHint, :memNm, :email, :cellPhone, :snsType, :snsId, :address)`;
